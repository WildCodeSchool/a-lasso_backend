...
import com.back_alasso.features.User.*;
...
@Transactional
class UserServiceIntegrationTest extends AbstractTests {
    ...
    void setup() {
        ...
        imageRepository.save(new Image("/images/Voluntary/defaultAvatar.png", ImageEnumType.AVATAR));
    }
    ...
    void registerVoluntary_shouldSaveVoluntaryAndAllRelatedEntities() {
        ...
        Assertions.assertEquals(AccountEnumType.ACTIVE, voluntary.get().getAccount_status());
