...
public class ImageMapper {
    ...
    public List<ImageResponseDTO> toResponseDTOs(List<UUID> imagesId, ImageEnumType type) {
        ...
        if (imagesId == null || imagesId.isEmpty()) {
            ...
            Image defaultImage = imageRepository.findFirstByUrl("/images/Activity/defaultActivityImage.jpg").orElseThrow(() -> new ResourceNotFoundException("Default Image not found"));
