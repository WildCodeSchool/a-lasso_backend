...
public class Voluntary extends User {
    ...
    public Voluntary(UserEnumType user_type, AccountEnumType account_status, String hashed_password, String email, String city, String first_name, String last_name, Country country, Image avatar, List<AssociationFollower> associationFollowers) {
