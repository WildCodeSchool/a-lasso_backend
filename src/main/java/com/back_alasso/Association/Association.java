...
public class Association extends User {
    ...
    public Association(String description, String founder, LocalDate foundationDate, String name, Address address, List<AssociationImage> associationImages, UserEnumType user_type,
                       AccountEnumType account_status,
                       String hashed_password,
                       String email,
                       List<AssociationFollower> associationFollowers) {
        super(
                user_type, account_status, hashed_password, email
        );
